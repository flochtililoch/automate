...
void function () {
  var AutomaticAPIClient, config, noErr, qs, randomBytes, request, url;
  ...
  AutomaticAPIClient = function () {
    ...
    function AutomaticAPIClient(param$) {
      ...
      this.fetch = function (endpoint, done) {
        return this.getAccessToken(function (this$) {
          return function (err, param$1) {
            ...
            if (null != err)
              return done(err);
            options = {
              headers: { Authorization: '' + this$.auth.method + ' ' + accessToken },
              uri: '' + this$.api.baseUrl + endpoint
            };
    ...
    AutomaticAPIClient.prototype.getTrips = function (done) {
      return this.fetch('/trips', done);
    };
    AutomaticAPIClient.prototype.getTrip = function (id, done) {
      return this.fetch('/trips/' + id, done);
    };
